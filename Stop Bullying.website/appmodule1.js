...
const showans3 = document.querySelector('.fa3')
...
const btnchoices3 = document.querySelector(".btn2-3")
const answers1 =document.querySelector('.fa2-1')
const answers2 =document.querySelector('.fa2-2')
const answers3 =document.querySelector('.fa2-3')
...
const btnchoices33 = document.querySelector(".btn3-3")
const answer1 =document.querySelector('.fa3-1')
const answer2 =document.querySelector('.fa3-2')
const answer3 =document.querySelector('.fa3-3')
...
const btnchoices334 = document.querySelector(".btn4-3")
const answer14 =document.querySelector('.fa4-1')
const answer24 =document.querySelector('.fa4-2')
const answer34 =document.querySelector('.fa4-3')
...
btnchoice1.addEventListener("click",()=>{
   showans1.classList.add("x1")
   showans1.classList.remove("hidefa")
   showans2.classList.add("x2")
   showans2.classList.remove("hidefa")
   showans3.classList.add("x3")
   showans3.classList.remove("hidefa")
...
btnchoice3.addEventListener("click",()=>{
    ...
    showans3.classList.add("x3")
    showans3.classList.remove("hidefa")
    btnchoice3.classList.add("answer")
    clearInterval(countdown); 
    addScore()
    gonxet2.classList.remove("op0")
    choicescetion.classList.add("answersection")
...
btnchoices1.addEventListener("click",()=>{
    answers1.classList.add("x1")
    answers1.classList.remove("hidefa")
    answers2.classList.add("x3")
    answers2.classList.remove("hidefa")
    answers3.classList.add("x2")
    answers3.classList.remove("hidefa")
...
btnchoices3.addEventListener("click",()=>{
    answers1.classList.add("x1")
    answers1.classList.remove("hidefa")
    answers2.classList.add("x3")
    answers2.classList.remove("hidefa")
    answers3.classList.add("x2")
    answers3.classList.remove("hidefa")
    btnchoices3.classList.add("answer")
    choicescetion2.classList.add("answersection")
    clearInterval(timerdown);
    gonxet3.classList.remove("op0")
    gonxet3.classList.add("next-box4")
...
btnchoices11.addEventListener("click",()=>{
    answer1.classList.add("x3")
    answer1.classList.remove("hidefa")
    answer2.classList.add("x1")
    answer2.classList.remove("hidefa")
    answer3.classList.add("x2")
    answer3.classList.remove("hidefa")
    btnchoices11.classList.add("answer")
    choicescetion3.classList.add("answersection")
    clearInterval(countdown1); 
    addScore()
    gonxet4.classList.remove("op0")
...
btnchoices22.addEventListener("click",()=>{
    ...
    answer3.classList.add("x2")
    answer3.classList.remove("hidefa")
    btnchoices22.classList.add("answer")
    choicescetion3.classList.add("answersection")
...
btnchoices33.addEventListener("click",()=>{
    answer1.classList.add("x3")
    answer1.classList.remove("hidefa")
    answer2.classList.add("x1")
    answer2.classList.remove("hidefa")
    answer3.classList.add("x2")
    answer3.classList.remove("hidefa")
    btnchoices33.classList.add("answer")
    choicescetion3.classList.add("answersection")
    clearInterval(countdown1);
    gonxet4.classList.remove("op0")
})
...
btnchoices114.addEventListener("click",()=>{
    answer14.classList.add("x3")
    answer14.classList.remove("hidefa")
    answer24.classList.add("x1")
    answer24.classList.remove("hidefa")
    answer34.classList.add("x2")
    answer34.classList.remove("hidefa")
...
btnchoices334.addEventListener("click",()=>{
    answer14.classList.add("x3")
    answer14.classList.remove("hidefa")
    answer24.classList.add("x1")
    answer24.classList.remove("hidefa")
    answer34.classList.add("x2")
    answer34.classList.remove("hidefa")
    btnchoices334.classList.add("answer")
    choicescetion4.classList.add("answersection")
    clearInterval(countdown1);
    gonxet5.classList.remove("op0")
})
